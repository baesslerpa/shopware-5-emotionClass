    ...
    {foreach $sEmotions as $emotion}
        ...
        {block name="widgets/emotion/index/container"}
            ...
            {block name="widgets/emotion/index/emotion"}
                <section class="{block name="widgets/emotion/index/classes"}emotion--container {$emotion.attribute.emotion_class} emotion--column-{$emotionCols} emotion--mode-{$emotionMode} emotion--{$emotion@index}{/block}"
                         data-emotion="true"
